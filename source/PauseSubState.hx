...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItemsOG:Array<String> = ['Resumo', 'Reiniciar Musica', 'Escolher Dificuldade', 'Modo Pra Praticar', 'Botplay', 'Editor de Notas', 'Sair para o menu'];
