function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		--Check if the note is a Sanes
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Sanes' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'Special'); --Change texture
			setPropertyFromGroup('unspawnNotes', i, 'hitHealth', 0.6); --Change amount of health to take when you hit like a fucking moron
		end
	end
